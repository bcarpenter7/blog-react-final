...
For example, the browser internally might render the webpage virtually at 980px then display it by shrinking it down to the devices actual screen size, e.g., 640px.  This is what leads to the scenario seen above.
