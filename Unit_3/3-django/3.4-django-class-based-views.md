...
The CBV will automatically try to "render" a template named **templates/<name_of_app>/book_list.html**. This takes the name of our UpperCamelCased *BookList* class and changes it to snake_case - *book_list*. This default convention can of course be overridden. 
