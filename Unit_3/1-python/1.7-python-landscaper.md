...
1. Create a GitHub repo, clone the repo, touch `game.py`. This is where you will be writing your code for this game. When you're done push your code to the repo you just created.
...
A GitHub Repo with a `game.py` file.
